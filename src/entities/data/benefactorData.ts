...
export const benefactors: BenefactorSchema[] = [
  /* =========================== LONG-TEAM BENEFACTORS ============================ */
  {
    ...
    benefactorDetails: {
      benefactorSynopsis: "Donna Farine is a UK-based boutique baking business founded and run by Sharai Gumbo, specialising in handcrafted scones and cake confectioneries, with custom orders available.",
      benefactorBio: "Donna Farine is a boutique baking business founded and run by Sharai Gumbo, a passionate baker based in the UK. A one-woman operation, Donna Farine is built on Sharai's love for creating beautifully handcrafted baked goods, with a speciality in scones and cake confectioneries. The business caters to customers seeking quality homemade treats, offering a bespoke custom order service for those looking for something truly special — whether for everyday indulgence or memorable occasions. With skill, creativity, and a personal touch in every bake, Sharai has built Donna Farine into a trusted name for delicious, made-with-love creations.",
      benefactorContactInfo: {
        ...
        facebook: {
          ...
          platformURL: "https://www.facebook.com/people/Donna-Farine/100075842006001/?mibextid=wwXIfr&rdid=deFMDvdIjw3q8hLO&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F17RJ2TnciR%2F%3Fmibextid%3DwwXIfr",
        },
        twitterX: {
