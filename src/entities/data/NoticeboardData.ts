...
export const noticeboardEntries: NoticeboardDataStructure[] = [  
  /* =========================== HEALTH ALERTS =========================== */
  {
    ...
    nbEntrySynopsis: "For babies who rely entirely on formula, repeated feedings can increase the amount of toxin consumed, and using contaminated formula for rehydration can worsen illness.",
    ...
    nbEntrySourceURL: "https://www.who.int/emergencies/disease-outbreak-news/item/2026-DON596",
  },
  {
    nbEntryType: "Health Alerts",
    ...
    nbEntrySynopsis: "Transmission of this recombinant virus already involves at least four countries in three WHO regions, and is therefore likely to be more widespread than currently documented.",
    ...
    nbEntrySource: "World Health Organization (WHO)",
    nbEntrySourceURL: "https://www.who.int/emergencies/disease-outbreak-news/item/2026-DON595",
  },
  ...
  /* =========================== SITE UPDATES ============================ */
  {
    ...
    nbEntrySynopsis: "Our Med-Courses Page is now live and packed full of educational content just for you!",
    nbEntryContent: "The Med-Course Page is now live and active with several courses on offer to help you better educate yourself in the medical space. Courses are carefully designed to be relevant and interactive with quizzes included in some course modules. So hop over there now to begin learning and improving!",
  ...
  },
  {
    ...
    nbEntryDate: "30-04-2026",
    nbEntrySynopsis: "Our Med-Blog Page is now live and filled with insightful reads curated just for you!",
  ...
  /* =========================== WELLNESS TIPS =========================== */
  {
    ...
    nbEntrySynopsis: "Drinking 2 liters of water daily can significantly improve cognitive function.",
  ...
  },
  {
    ...
    nbEntrySynopsis: "Reasons why you might feel tired and advice about what you can do to prevent tiredness.",
  ...
  },
  {
    ...
    nbEntrySynopsis: "Evidence suggests there are 5 steps you can take to improve your mental health and wellbeing. Trying these things could help you feel more positive and able to get the most out of life.",
    ...
    nbEntrySource: "National Health Service (NHS) UK",
    nbEntrySourceURL: "https://www.nhs.uk/mental-health/self-help/guides-tools-and-activities/five-steps-to-mental-wellbeing/",
  },
]