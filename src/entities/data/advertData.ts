...
export const advertisements: AdvertisementDataStructure[] = [
  ...
  /* =========================== LONG-TERM BENEFACTOR ADS =========================== */
  {
    ...
    advertisementThumbnail: {
      avifPath:
        "assets/images/avif/advert-cover-benefactor-lt-donnaFarine.avif",
      pngPath: "assets/images/png/advert-cover-benefactor-lt-donnaFarine.png",
      webpPath:
        "assets/images/webp/advert-cover-benefactor-lt-donnaFarine.webp",
    ...
    advertisementBtnContent: {
      advertisementURL:
        "mailto:donsharai@gmail.com?subject=Custom Order Enquiry&body=Hi Donna Farine,%0D%0A%0D%0AI would like to place a custom order. Here are my details:%0D%0A%0D%0AName: (Please replace this text with your name.)%0D%0AOrder details: (Please replace this text with your order details. Such as size of cake, flavour, writing)%0D%0APreferred date: (Please replace this text with your preferred date to receive your order.)%0D%0AContact Information: (Please replace this text with your contact information, if different to the email you sent this message with.)%0D%0D%0A%0D%0AThank you!",
  ...
  },
  {
    ...
    advertisementThumbnail: {
      avifPath:
        "assets/images/avif/advert-cover-benefactor-lt-makeItBright.avif",
      pngPath: "assets/images/png/advert-cover-benefactor-lt-makeItBright.png",
      webpPath:
        "assets/images/webp/advert-cover-benefactor-lt-makeItBright.webp",
      altText:
        "Advert Cover: Make It Bright Cleaning Solutions Professional Home Cleaning Services",
    },
